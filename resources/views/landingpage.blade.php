    ...
    <header id="page-header">
      ...
      <div class="content-header">
        ...
        <div class="space-x-1 d-flex align-items-center space-x-2">
          ...
          <!-- Version -->
          <span class="d-inline-block fs-xs fw-medium bg-primary-dark text-white rounded-pill py-1 px-2">1.3</span>
          <!-- END Version -->
        </div>
        <!-- END Left Section -->
              ...
              <div class="col-md-5 py-4 d-flex align-items-center">
                <div class="text-center text-md-start">
                  <h1 class="fw-bold fs-2 mb-3">
                    Next generation, multipurpose social media
                  </h1>
                  <p class="text-muted fw-medium mb-4">
                    Clasez App is a super flexible solution built with <span class="fw-semibold">heart and full effort</span>, Use it to save all memories and create a Creativity content with friendly and fast user interface. <span class="fw-semibold">No Racism</span> in the unity and the diversity <a class="fw-semibold" href="javascript:void(0)" data-toggle="layout" data-action="dark_mode_toggle"></a>.
                  </p>
                  <a class="btn btn-alt-primary py-3 px-4" href="{{route('login')}}" target="_blank">
